...
| 2019 | **Adversarial Attacks on Graph Neural Networks via Meta Learning**  | Defense  | Node Classification   | GCN, CLN, DeepWalk | ICLR 2019 | [Link](https://arxiv.org/abs/1902.08412) |
| 2018 | **GA Based Q-Attack on Community Detection**  | Attack  | Community Detection   | modularity | Arxiv| [Link](https://arxiv.org/abs/1811.00430) |
...
| 2018 | **Adversarial attacks on node embeddings**  | Attack  | Node Classification, Community Detection   | node2vec, DeepWalk, GCN, LINE | Arxiv| [Link](https://arxiv.org/abs/1809.01093#) |
...
| 2017 | **Practical Attacks Against Graph-based Clustering**  | Attack  | Graph Clustering   | SVD, node2vec | CCS 2017| [Link](https://arxiv.org/abs/1708.09056) |
